...
//        updateLoginInfo();
        ...
        Preference broFile = findPref("broFile");
        broFile.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                Intent intent = new Intent(preference.getContext(), BrowseFileActivity.class);
                startActivity(intent);
                return true;
            }
        });
